...
class Html extends Component {
    render() {
        const { user, password, confirmPass, mailBox, phone, success, onChangeInput, BlurChangeInput, onPasswordInput, BlurPasswordInput, onConfirmPassword, BlurconfirmPass, onMainBox, BlurMainBox, onPhoneInput, BlurPhoneInput, onSubmit, onReset } = this.props
        return (
            <div>
                <form>
                ...
                {
                    success && <div className="success">正在请求中......</div>
                }
            </div>
        )
    }
